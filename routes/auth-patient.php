...
Route::middleware(GuestPatient::class)->prefix('patient')->as('patient.')->group(function () {
    ...
    Route::get('login', [LoginPatientController::class, 'create'])
        ->name('login');

    Route::post('login', [LoginPatientController::class, 'store']);
...
Route::middleware('auth:patient')->prefix('patient')->as('patient.')->group(function () {
   ...
   Route::post('logout', [LoginPatientController::class, 'destroy'])
       ->name('logout');
});
