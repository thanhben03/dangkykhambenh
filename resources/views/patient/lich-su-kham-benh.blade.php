                        ...
                        <div class="card">
                            {{-- <div class="card-header">
                                ...
                                <ul class="nav nav-tabs" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="#info-{{ $patient['id'] }}" aria-controls="info"
                                            role="tab" data-bs-toggle="tab">Thông Tin Bệnh Nhân</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#history-{{ $patient['id'] }}" aria-controls="history"
                                            role="tab" data-bs-toggle="tab">Lịch Sử Khám Bệnh</a>
                                    </li>
                                </ul>
                                            ...
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-10">
                                                    <input readonly value="{{ $patient['telephone'] }}" type="tel"
                                                        class="form-control" id="telephone" name="reg_ptel">
                                                </div>
                                            </div>
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-2">
                                                    <input readonly value="{{ $patient['sex'] }}" type="text"
                                                        class="form-control" id="sex" name="reg_poccupation">
                                                </div>
                                                ...
                                                <div class="col-sm-3 text-end">
                                                    <div class="btn-group">
                                                        <button type="button" onclick="go('9')" class="btn btn-info"><i
