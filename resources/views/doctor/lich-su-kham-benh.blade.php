        ...
        <div class="page-content">
            <div class="container-fluid custom-content">
                ...
                <form id="search-form" class="mb-3" action="/medical-history" method="GET">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <a href="/medical-history" class="btn btn-success">Quay lại</a>
                        </div>
                    </div>
                </form>
                ...
                @if (count($patients) > 0)
                                        ...
                                        <div class="tab-content p-3">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade show active"
                                                ...
                                                <form action="/editpatient" method="POST">
                                                    ...
                                                    <div class="mb-3 row">
                                                        <label for="telephone" class="col-sm-2 col-form-label">Số điện
                                                            thoại</label>
                                                        <div class="col-sm-10">
                                                    ...
                                                    <div class="mb-3 row">
                                                        <label for="sex" class="col-sm-2 col-form-label">Giới
                                                            tính</label>
                                                        <div class="col-sm-2">
                                                            <input readonly
                                                                value="{{ $patient['sex'] === 'Male' ? 'Nam' : 'Nữ' }}"
                                                                type="text" class="form-control" id="sex"
                                                                name="reg_poccupation">
                                                        </div>
                                                        <label for="dob" class="col-sm-2 col-form-label">Năm
                                                            sinh</label>
                                                        <div class="col-sm-3">
                    ...
                    @endforeach
                    @else
                    <h4>Không tìm thấy lịch khám nào !</h4>
                @endif
